...
class W2F_Page_Widget extends WP_Widget {
	...
	function W2F_Page_Widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'w2f_page_widget', 'description' => __('A widget to display a featured page.', 'web2feel') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'w2f_page_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'w2f_page_widget', __('W2F Featured Page Widget', 'web2feel'), $widget_ops, $control_ops );
	}
...
<?php
	$high_query = new WP_Query(array('page_id' => $page_id ) );
 ?>
...
<?php
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'page_id' ); ?>"><?php _e('Page ID:', 'web2feel'); ?></label>
